...
export class LiveEventsHubService {
  ...
  get events$(): Observable<LiveEventDto | null> {
  ...
  start(): void {
    ...
    this.connection.onclose((err) =>
      console.log('[LiveEvents] connection closed', err)
    );
    this.connection.onreconnecting(() =>
      console.log('[LiveEvents] reconnecting...')
    );
    this.connection.onreconnected(() =>
      console.log('[LiveEvents] reconnected')
    );
